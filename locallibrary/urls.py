...
urlpatterns += [
    ...
    path("accounts/ password_change/ [name='password_change_done']", include("django.contrib.auth.urls")),
    path("accounts/ password_change/done/ [name='password_change_done']", include("django.contrib.auth.urls")),
    path("accounts/ password_reset/ [nane='password_reset']", include("django.contrib.auth.urls")),
